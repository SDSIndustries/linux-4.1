cmd_arch/arm/boot/dts/sama5d36ek.dtb := mkdir -p arch/arm/boot/dts/ ; /usr/bin/arm-linux-gnueabi-gcc -E -Wp,-MD,arch/arm/boot/dts/.sama5d36ek.dtb.d.pre.tmp -nostdinc -I./arch/arm/boot/dts -I./arch/arm/boot/dts/include -I./drivers/of/testcase-data -undef -D__DTS__ -x assembler-with-cpp -o arch/arm/boot/dts/.sama5d36ek.dtb.dts.tmp arch/arm/boot/dts/sama5d36ek.dts ; ./scripts/dtc/dtc -O dtb -o arch/arm/boot/dts/sama5d36ek.dtb -b 0 -i arch/arm/boot/dts/  -d arch/arm/boot/dts/.sama5d36ek.dtb.d.dtc.tmp arch/arm/boot/dts/.sama5d36ek.dtb.dts.tmp ; cat arch/arm/boot/dts/.sama5d36ek.dtb.d.pre.tmp arch/arm/boot/dts/.sama5d36ek.dtb.d.dtc.tmp > arch/arm/boot/dts/.sama5d36ek.dtb.d
